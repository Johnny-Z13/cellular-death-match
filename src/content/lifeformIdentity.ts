...
export const LIFEFORM_IDENTITIES: Record<LifeformIdentityId, LifeformIdentity> = {
  swarmlet: {
    ...
    origin: 'Initial laboratory egg strain.',
  ...
  bruiser: {
    ...
    origin: 'Genome decoded by reproducing a toxin-pressure bloom.',
  ...
  splitter: {
    ...
    origin: 'Genome decoded by carrying nutrient through budding tissue.',
