...
export const LIFEFORM_IDENTITIES: Record<LifeformIdentityId, LifeformIdentity> = {
  ...
  needle_swarm: {
    ...
    behavior: BREED_DEFS.needle_swarm.discoveryTrigger,
  ...
  folded_anchor: {
    ...
    behavior: BREED_DEFS.folded_anchor.discoveryTrigger,
  ...
  glass_antibody: {
    ...
    behavior: BREED_DEFS.glass_antibody.discoveryTrigger,
  ...
  bloom_mass: {
    ...
    behavior: BREED_DEFS.bloom_mass.discoveryTrigger,
  ...
  static_lattice: {
    ...
    behavior: BREED_DEFS.static_lattice.discoveryTrigger,
